...
<body>
    ...
    <div class="content">
        ...
        <div class="card mt-4">
            <div class="card-body">
                <?php if ($payment['payment_method'] === "qr" && $_GET['status'] == 'pending'): ?>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <?php if (!empty($payment['payment_image'])) : ?>
                                <img id="imagePreview" src="../admin_page/payment_image/<?php echo $payment['payment_image']; ?>" alt="Image Preview" style="max-width: 200px; margin-top: 10px; cursor: pointer;" onclick="viewImage()">
                            <?php else : ?>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <?php if ($payment['payment_date'] === 'qr') : ?>
                                <p id="payment_date"><?php echo $payment['payment_date']; ?></p>
                            <?php else : echo date("00/00/0000"); ?>
                ...
                <?php endif; ?>
                <?php if ($_GET['status'] == 'pending' || $_GET['status'] == 'pickup'): ?>
                ...
                <?php else : ?>
                    <button type="back" class="btn btn-secondary mt-4 w-100" onclick="window.history.back()">ย้อนกลับ</button>
                <?php endif; ?>
            </div>
        </div>
