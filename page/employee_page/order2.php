    ...
    <div class="content">
        ...
        <div class="card mt-4">
                ...
                <div class="card-body">
                    <?php if ($payment): ?>
                        ...
                        <?php if ($payment['payment_image']): ?>
                            <p><strong>รูปหลักฐานการชำระเงิน:</strong> <img src="../admin_page/payment_image/<?php echo htmlspecialchars($payment['payment_image']); ?>" width="100"></p>
                        <?php endif; ?>
            ...
            <div class="card-body">
                ...
                <?php if ($delivery) : ?>
                    <p><strong>จัดส่งโดย:</strong> <?php echo $delivery['delivery_by']; ?></p>
                    <p><strong>หมายเลขพัสดุ:</strong> <?php echo $delivery['parcel_number']; ?></p>
            ...
            <div class="card-body">
                <h5 class="card-title">เปลี่ยนสถานะ</h5>
                <form method="POST">
