        ...
        <form id="editProductForm" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <?php if ($product['image']): ?>
                    <img src="../admin_page/<?php echo htmlspecialchars($product['image']); ?>" alt="Product Image" class="img-fluid" style="max-width: 35%">>
                <?php else: ?>
                    <p>No image</p>
                <?php endif; ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#resultModal').on('hidden.bs.modal', function() {
                window.location.href = '/myWeb/page/employee_page/stockproduct.php';
            });
        });
    </script>
</body>
